      ...
      <div v-for="location in locations" :key="location.id" class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-2 text-sm text-gray-600">
          ...
          <div class="flex items-center">
            <span :class="location.is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'" 
...
const loadLocations = async () => {
  try {
    ...
    alert('Failed to load locations: ' + (error.response?.data?.message || error.message))
  }
}
